package com.example.appercodetest.model
...
data class UserDetail(
    ...
    @SerializedName("site_admin") var isSiteAdmin: Boolean,
    @SerializedName("name") var name: String,
    @SerializedName("company") var company: String,
    @SerializedName("blog") var blog: String,
    @SerializedName("location") var location: String,
    @SerializedName("email") var email: String?,
    @SerializedName("hireable") var isHireable: Boolean?,
    ...
    @SerializedName("created_at") var creratedAt: String,
